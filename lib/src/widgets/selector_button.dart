...
class SelectorButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => selectorConfig.selectorType == PhoneInputSelectorType.DROPDOWN
      ...
      : MaterialButton(
          ...
          onPressed: countries.isNotEmpty && countries.length > 1 && isEnabled
              ...
              : null,
          child: Padding(
            padding: const EdgeInsets.only(right: 8.0, bottom: 2.5),
            child: Item(
              country: country,
              showFlag: selectorConfig.showFlags,
              useEmoji: selectorConfig.useEmoji,
          ...
          children: [
            ...
            Padding(
              ...
              child: DraggableScrollableSheet(
                builder: (BuildContext context, ScrollController controller) => Directionality(
                  textDirection: Directionality.of(inheritedContext),
                  child: DecoratedBox(
